...
export const Arryoficons = [
  ...
  // { icon: "/images/icons/candel.svg", iconid: 3, iconname: "p" },
  // { icon: "/images/icons/cofe.svg", iconid: 4, iconname: "l" },
  // {
  //   icon: "/images/icons/cumputer.svg",
  //   iconid: 5,
  //   iconname: "pe-7s-plug",
  // },
  // { icon: "/images/icons/electriseti.svg", iconid: 7, iconname: "r" },
  // { icon: "/images/icons/garbege.svg", iconid: 8, iconname: "t" },
  // {
  //   icon: "/images/icons/sabres.svg",
  //   iconid: 9,
  //   iconname: "fa fa-shower",
  // },
  // { icon: "/images/icons/table.svg", iconid: 10, iconname: "v" },
  // {
